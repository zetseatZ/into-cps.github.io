...
* [MultiModel: Change the FMU path to (if from the FMUs folder) show the relative path - (2016-06-02)](https://github.com/into-cps/intocps-ui/issues/53)
* [MultiModel: When the input of an unconfirmed sv is unchecked it still complains  - (2016-06-02)](https://github.com/into-cps/intocps-ui/issues/52)
* [MultiModel: Changing a parameter of type real to `3.0` from `2.5` gives type error - (2016-06-02)](https://github.com/into-cps/intocps-ui/issues/51)
